...
pub struct Backend {
    ...
    pub documents: DashMap<String, IndexedText<String>>,
    pub symbols: DashMap<char, Vec<String>>,
    pub chinese_symbols: String,
}
...
impl Backend {
    pub async fn turn_completion(&self, params: Value) {
